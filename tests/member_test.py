...
class TestMember(unittest.TestCase):
    ...
    def test_member_has_first_name(self):
        self.assertEqual("Jessica", self.member_1.first_name)



    # def test_member_has_last_name(self):
    #     self.assertEqual("Fletcher", self.member_1.last_name)
    ...
    #     self.assertEqual("jessica.fletcher@email.com", self.member_1.email)